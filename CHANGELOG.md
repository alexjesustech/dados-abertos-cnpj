...
- **`.env.sops.yaml` desversionado** (2026-06-11, política nova da workstation — ciphertext
  ...
  `env — dados-abertos-cnpj` do Bitwarden Personal Vault. O `.sops.yaml` (config de
