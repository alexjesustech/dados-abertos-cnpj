...
class Settings(BaseSettings):
    ...
    db_path: Path = Field(default=ROOT / "dados_cnpj.db", description="Caminho do SQLite com dados ingeridos.")
    api_bind: str = Field(default="127.0.0.1", description="Endereço de bind do uvicorn (padrão local-only).")
